...
<div class="formbody">
    ...
    <div class="tab mt10" id="tabid1">
        ...
        <table class="formtable">
            <tbody>
            <tr id="" class="">
                <td class="ft_title">租户头像</td>
                <td colspan="3">
                    <img class="wximg" src="<?php echo ($model["headimgurl"]); ?>"/>
                </td>
            </tr>
            <tr id="" class="">
                <td class="ft_title">租户昵称</td>
                <td colspan="3"><?php echo ($model["user_name"]); ?></td>
            </tr>
            <tr id="" class="">
                <td class="ft_title">车牌号</td>
                <td colspan="3"><?php echo ($model["car_number"]); ?></td>
            </tr>
            <tr id="" class="">
                <td class="ft_title">出租时间</td>
    ...
    <div class="formtitle"><span>评论详情</span></div>
    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="tab mt10" id="tabid1">
        <table class="formtable">
            <tbody>
                <tr id="" class="">
                    <td class="">
                        <div class="sptimg">
                            <img class="wximg" src="<?php echo ($vo["headimgurl"]); ?>"/>
                            <label><?php echo ($vo["user_name"]); ?></label>
                        </div>
                    </td>
                    <td colspan="3"><?php echo ($vo["content"]); ?></td>
                </tr>
                <tr id="" class="">
                    <td class="ft_title">打分</td>
                    <td colspan="3"><?php echo ($vo["grade"]); ?></td>
                </tr>
                <tr id="" class="">
                    <td class="ft_title">评论时间</td>
                    <td colspan="3"><?php echo date('Y-m-d H:i:s',$vo['addtime']);?></td>
                </tr>
            </tbody>
        </table>
