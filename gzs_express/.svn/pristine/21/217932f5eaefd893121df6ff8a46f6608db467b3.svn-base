        ...
        <div class="collapse navbar-collapse navv" id="menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a href="#"><img data-original="/czq/Vrent/Public/Index/images/location.png"
                                     class="location_img lazy">韶关</a></li>
            </ul>
...
<div class="start_div lazy" data-original="/czq/Vrent/Public/Index/images/c.jpg">
    <div class="black_cover">
        ...
        <div class="">
            <button type="button" class="start_btn">开始赚钱</button>
        </div>
    </div>
</div>
                    ...
                    <div class="parent" onclick=window.open("<?php echo U('Detail/detail',array('car_id'=>$vo['car_id']));?>");>
                        ...
                        <div class="price_div img">
                            <span class="today_price">￥<?php echo ($vo["price"]); ?>/今日</span><span
                                class="car_detail"><?php echo ($vo["intro"]["gear"]); ?></span><span
...
消除您的后顾之忧。</span></div>
    <div class="span_div"><span class="span_one">您可以低于市价30%的价格租好车</span><span class="span_two">您选择的车辆全部来自VR严格审核把关的车主私车，无论您希望经济出行，亦或是奢华体验，我们都用心满足您的要求。</span>
    </div>
    <div class="span_div span_div2"><span class="span_one">最高100%押金减免，让您租车不差钱</span><span class="span_two">我们建立严谨的信用机制，只需简单几步验证，最高减免100%租车押金，世界那么大，随便您看看。</span>
    </div>
</div>
