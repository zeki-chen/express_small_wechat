...
<div class="rightinfo">
    ...
    <div class="tools">
        <ul class="toolbar">
            <li><a href="<?php echo U('Admin/add');?>"><span><img src="/czq/Vrent/Public/Admin/images/t01.png" /></span>添加</a></li>
            <li><a href="javascript:delMut('<?php echo U("Admin/doDel");?>')"><span><img src="/czq/Vrent/Public/Admin/images/t03.png" /></span>删除</a></li>
        </ul>
    </div>
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <th class="ft">管理员账号</th>
            <th width="300">是否有效</th>
            <th>操作</th>
        </tr>
        </thead>
        ...
        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                <td><input name="aid" type="checkbox" class="del_checkbox" value="<?php echo ($vo["aid"]); ?>" /></td>
                <td class="ft"><?php echo ($vo["aname"]); ?></td>
                ...
                <td>
                    ...
                    <a class="delBtn tablelink" href="<?php echo U('Admin/doDel',array('ids'=>$vo['aid']));?>" del_title="<?php echo ($vo["aname"]); ?>" >删除</a>
                    <span>|</span>
                    <a href="<?php echo U('Admin/pwd',array('aid'=>$vo['aid']));?>" class="tablelink">重置密码</a>
                </td>
