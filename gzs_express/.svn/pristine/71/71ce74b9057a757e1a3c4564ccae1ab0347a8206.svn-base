...
<div class="rightinfo">
    ...
    <div class="tools">
        <ul class="toolbar">
            <li><a href="javascript:delMut('<?php echo U("User/doDel");?>')"><span><img src="/czq/Vrent/Public/Admin/images/t03.png" /></span>删除</a></li>
        </ul>
    </div>
    ...
    <table class="tablelist">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                <td><input name="wx_id" class="del_checkbox" type="checkbox" value="<?php echo ($vo["wx_id"]); ?>" /></td>
                <td class="ft"><img class="wximg" src="<?php echo ($vo["headimgurl"]); ?>"/></td>
                <td>
                    <?php echo ($vo["user_name"]); ?>
                </td>
                <td>
                    <a href="<?php echo U('User/view',array('wx_id'=>$vo['user_id']));?>" class="tablelink">查看</a>
                    <span>|</span>
                    <a class="delBtn tablelink" href="<?php echo U('User/doDel',array('ids'=>$vo['user_id']));?>" del_title="<?php echo ($vo["user_name"]); ?>" >删除</a>
                    <span>
                </td>
